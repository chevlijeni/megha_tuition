...
class _MainScaffoldState extends State<MainScaffold> {
  ...
  final List<Widget> _screens = [
    ...
    const CollectFeeScreen(isTab: true),
    const ReportsScreen(),
        ...
        return Scaffold(
          ...
          bottomNavigationBar: Container(
            decoration: BoxDecoration(
              color: isDark ? AppTheme.surfaceDark : AppTheme.navBackground,
              ...
              boxShadow: [
                BoxShadow(
                  color: (isDark ? Colors.black : AppTheme.primaryBlue).withOpacity(0.1),
                  blurRadius: 30,
            ...
            child: SafeArea(
              child: Padding(
                ...
                child: BottomNavigationBar(
                  ...
                  unselectedItemColor: (isDark ? Colors.white : AppTheme.textSecondary).withOpacity(0.5),
